...
var _Deck_instances, _Deck_heuristic, _Deck_sort, _Deck_dump, _YapityFlashcards_instances, _YapityFlashcards_flip, _YapityFlashcards_showCard, _YapityFlashcards_nextCard, _YapityFlashcards_cardInteraction;
class Deck {
    constructor(cards) {
        _Deck_instances.add(this);
        this.cards = cards;
        __classPrivateFieldGet(this, _Deck_instances, "m", _Deck_sort).call(this);
        __classPrivateFieldGet(this, _Deck_instances, "m", _Deck_dump).call(this);
    }
    draw() {
